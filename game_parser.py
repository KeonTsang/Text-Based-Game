...
allow_words = ["damage", "help", "go", "north", "south", "west", "east", "take", "drop", "map", "keycard", "look", "spare", "talk", "attack", "action", "inspect", "observe", "examine", "use", "NUcL3@R", "keypad", "stethoscope", "centrifuge", "testtube", "fist", "raygun", "bunsen", "note", "paper", "painting"]
